...
public class TelegramRemoteService extends TelegramLongPollingBot {
    ...
    public SendMessage sendButtons(long chatId) {
        ...
        keyboard.add(List.of(createButton("Потерял носок \uD83D\uDE22", "lost_sock")));
        keyboard.add(List.of(createButton("Как огурец на полке \uD83D\uDE10", "cucumber")));
        keyboard.add(List.of(createButton("Готов к танцам \uD83D\uDE04", "dance_ready")));
        keyboard.add(List.of(createButton("Где мой кофе?! \uD83D\uDE23", "need_coffee")));
        keyboard.add(List.of(createButton("Слипаются глаза \uD83D\uDE29", "sleepy")));
    ...
    InlineKeyboardButton createButton(String name, String data) {
